...
import { localizedEducation, useLanguage } from '@/i18n';
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {education.map((edu, index) => (
            ...
            >
              ...
              <p className="mt-1 text-sm font-medium text-ink-700">{localizedEducation[language][index][0]}</p>
              <p className="mt-0.5 text-sm text-ink-500">{localizedEducation[language][index][1]}</p>
            </div>
          ))}
        </div>
